...
#include "DPModels/EfficiencyPolarizationCounter.h"
#include <cstdlib>
#include <string>
...
int main(int argc, char *argv[])
{
 ...
 bool polarization_calc = static_cast<unsigned int>( atoi( argv[ 10 ] ) ) == 1;
 ...
 if ( argc == 13 )
 {
  ...
  prompt_energy = atof( argv[ 11 ] );
  propmt_energy_threshold = atof( argv[ 12 ] );
 }

 if ( polarization_calc )
 {

  EfficiencyPolarizationCounter model;
